...
public class RemoteServiceImpl extends UnicastRemoteObject implements RemoteService {
    ...
    /**
     * Costruttore della classe RemoteServiceImpl.
     *
     ...
     */
    @Override
    public AreaGeografica cercaPerCoordinate(double latitudine, double longitudine) throws RemoteException {
     ...
     * @param notaAltitudineGhiacciai Note aggiuntive sull'altitudine dei ghiacciai.
     * @param MassaGhiacciai La massa dei ghiacciai.
     * @param scoreMassaGhiacciai Il punteggio della massa dei ghiacciai.
     * @param notaMassaGhiacciai Note aggiuntive sulla massa dei ghiacciai.
     * @return Un valore indicante il risultato dell'inserimento.
     * @throws RemoteException Se si verifica un errore di comunicazione remota.
     */
    @Override
