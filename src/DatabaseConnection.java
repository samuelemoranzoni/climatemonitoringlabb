...
public class DatabaseConnection {
    ...
    /**
     * Permette il login di un operatore, restituendo l'istanza di OperatoreRegistrato.
     *
     * @param userid   l'userid dell'operatore.
     * @param password la password dell'operatore.
     * @return l'oggetto OperatoreRegistrato in caso di successo,
     ...
     * @return un'istanza di AreaGeografica o null se non trovata.
     */
     ...
     * @return una lista di oggetti Note associati all'area specificata.
     */
