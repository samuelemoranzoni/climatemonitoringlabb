...
/**
 * La classe <code>climatemonitoring.AreaRiservataOperatorFrame</code> rappresenta una finestra dell'interfaccia grafica
...
public class AreaRiservataOperatorFrame extends JFrame {
    ...
    public AreaRiservataOperatorFrame()  {
        ...
        Registry registry = null; // Assicurati che l'indirizzo e la porta siano corretti
        try {
