 ...
 * Implementa il pattern Singleton per garantire che ci sia solo un'istanza di climatemonitoring.OperatoreSession.
 * @author Moranzoni Samuele
 * @author Di Tullio Edoardo
 */
public class OperatoreSession {
    private static OperatoreSession instance;  // Istanza unica della classe climatemonitoring.OperatoreSession
    ...
    /**
     * Restituisce l'istanza unica di climatemonitoring.OperatoreSession.
     * Se l'istanza non esiste, viene creata una nuova istanza.
     *
     * @return istanza corrente di climatemonitoring.OperatoreSession
     */
