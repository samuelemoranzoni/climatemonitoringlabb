...
public class ParametriClimatici implements Serializable {
    ...
    /**
     * Costruttore della classe <code>climatemonitoring.climatemonitoring.model.climatemonitoring.ParametriClimatici</code> che inizializza tutti i parametri climatici.
     *
    ...
    /**
     * Restituisce una rappresentazione in forma di stringa di <code>climatemonitoring.climatemonitoring.model.climatemonitoring.ParametriClimatici</code>.
     *
     * @return una stringa con i dettagli dei parametri climatici
     */
    @Override
    public String toString() {
        return "climatemonitoring.climatemonitoring.model.climatemonitoring.ParametriClimatici{\n" +
